...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "user_type", sa.Enum("client", "developer", name="usertype"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_client_profiles_id"), "client_profiles", ["id"], unique=False
    )
    op.create_table(
        "developer_profiles",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "PUBLISHED", "ARCHIVED", name="productstatus"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["developer_id"], ["developer_profiles.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        op.f("ix_developer_ratings_developer_id"),
        "developer_ratings",
        ["developer_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_developer_ratings_user_id"),
        "developer_ratings",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["product_id"], ["marketplace_products.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_product_downloads_id"), "product_downloads", ["id"], unique=False
    )
    op.create_table(
        "product_files",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_product_reviews_id"), "product_reviews", ["id"], unique=False
    )
    op.create_table(
        "requests",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum(
                "open", "in_progress", "completed", "cancelled", name="requeststatus"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["request_comments.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["request_id"], ["requests.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_request_shares_id"), "request_shares", ["id"], unique=False
    )
    op.create_table(
        "showcase_ratings",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_snagged_requests_id"), "snagged_requests", ["id"], unique=False
    )
    op.create_table(
        "videos",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "video_type",
            sa.Enum(
                "project_overview", "solution_demo", "progress_update", name="videotype"
            ),
            nullable=False,
        ),
        sa.Column("share_token", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_videos_share_token"), "videos", ["share_token"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["comment_id"], ["request_comments.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("user_id", "comment_id"),
        sa.UniqueConstraint(
            "user_id", "comment_id", name="unique_request_comment_vote"
        ),
    )
    op.create_table(
        "showcase_videos",
    ...
    op.create_index(
        op.f("ix_conversation_content_links_id"),
        "conversation_content_links",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_conversation_content_links_id"),
        table_name="conversation_content_links",
    )
    ...
    op.drop_index(
        op.f("ix_developer_ratings_developer_id"), table_name="developer_ratings"
    )
    ...
    # ### end Alembic commands end of commands ###
